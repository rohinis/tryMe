...
try {
	...
	else
	{
		...
		extentTest.log(LogStatus.PASS, 'Looking for Folder - '+folderName+' to perfrom operation - ' + TestOperation)
		...
		if (fileItem) {
			...
			extentTest.log(LogStatus.PASS, 'Clicked on Folder    - ' + folderName)
			if(userChoice.equals('DoubleClick'))
			{
			...
			else
			{
				...
				extentTest.log(LogStatus.PASS, 'RightClicked on Folder  - ' + folderName)
				WebUI.delay(2)
